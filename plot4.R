...
png('plot4.png')
par(mfrow=c(2,2))
plot(sub$DateTime,sub$Global_active_power,pch=NA,xlab="",ylab="Global Active Power (kilowatts)")
lines(sub$DateTime, sub$Global_active_power)
plot(sub$DateTime, sub$Voltage, ylab="Voltage", xlab="datetime", pch=NA)
...
with(sub, plot(DateTime, Global_reactive_power, xlab='datetime', pch=NA))
